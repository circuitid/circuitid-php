...
```php
createFax($faxes): \OpenAPI\Client\CircuitID\GetFax200Response
```
...
[**\OpenAPI\Client\CircuitID\GetFax200Response**](../Model/GetFax200Response.md)
...
```php
getFax($id): \OpenAPI\Client\CircuitID\GetFax200Response
```
...
```php
removeFax($id): \OpenAPI\Client\CircuitID\GetFax200Response
```
