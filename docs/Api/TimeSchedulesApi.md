...
[**\OpenAPI\Client\CircuitID\GetTimeSchedule200Response**](../Model/GetTimeSchedule200Response.md)
...
```php
getTimeSchedule($id): \OpenAPI\Client\CircuitID\GetTimeSchedule200Response
```
...
```php
removeTimeSchedule($id): \OpenAPI\Client\CircuitID\GetTimeSchedule200Response
```
