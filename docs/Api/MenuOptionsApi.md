...
```php
createMenuOption($menuoptions): mixed
```
...
$apiInstance = new OpenAPI\Client\Api\MenuOptionsApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$menuoptions = new \OpenAPI\Client\CircuitID\Menuoptions(); // \OpenAPI\Client\CircuitID\Menuoptions | The JSON object that will be posted to the REST API endpoint.

try {
    $result = $apiInstance->createMenuOption($menuoptions);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **menuoptions** | [**\OpenAPI\Client\CircuitID\Menuoptions**](../Model/Menuoptions.md)| The JSON object that will be posted to the REST API endpoint. | |
...
try {
    $result = $apiInstance->getMenuOption($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MenuOptionsApi->getMenuOption: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
patchMenuOption($id, $menuoptionsNotRequired): mixed
```
...
$id = NULL; // mixed | The ObjectId (unique 12 bytes ID) of record you would like to GET.
$menuoptionsNotRequired = new \OpenAPI\Client\CircuitID\MenuoptionsNotRequired(); // \OpenAPI\Client\CircuitID\MenuoptionsNotRequired | The request data.

try {
    $result = $apiInstance->patchMenuOption($id, $menuoptionsNotRequired);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | [**mixed**](../Model/.md)| The ObjectId (unique 12 bytes ID) of record you would like to GET. | |
| **menuoptionsNotRequired** | [**\OpenAPI\Client\CircuitID\MenuoptionsNotRequired**](../Model/MenuoptionsNotRequired.md)| The request data. | |
...
try {
    $result = $apiInstance->removeMenuOption($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MenuOptionsApi->removeMenuOption: ', $e->getMessage(), PHP_EOL;
}
```
