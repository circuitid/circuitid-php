...
```php
createMenuOption($menuoptions): \OpenAPI\Client\CircuitID\GetMenuOption200Response
```
...
[**\OpenAPI\Client\CircuitID\GetMenuOption200Response**](../Model/GetMenuOption200Response.md)
...
```php
getMenuOption($id): \OpenAPI\Client\CircuitID\GetMenuOption200Response
```
...
```php
removeMenuOption($id): \OpenAPI\Client\CircuitID\GetMenuOption200Response
```
