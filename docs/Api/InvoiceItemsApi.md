...
```php
getInvoiceItem($id): \OpenAPI\Client\CircuitID\GetInvoiceItem200Response
```
...
[**\OpenAPI\Client\CircuitID\GetInvoiceItem200Response**](../Model/GetInvoiceItem200Response.md)
