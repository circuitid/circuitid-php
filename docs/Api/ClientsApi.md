...
```php
createClient($clients): \OpenAPI\Client\CircuitID\GetClient200Response
```
...
[**\OpenAPI\Client\CircuitID\GetClient200Response**](../Model/GetClient200Response.md)
...
```php
getClient($id): \OpenAPI\Client\CircuitID\GetClient200Response
```
...
```php
removeClient($id): \OpenAPI\Client\CircuitID\GetClient200Response
```
