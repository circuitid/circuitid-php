...
$clients = new \OpenAPI\Client\CircuitID\Clients(); // \OpenAPI\Client\CircuitID\Clients | The JSON object that will be posted to the REST API endpoint.

try {
    $result = $apiInstance->createClient($clients);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **clients** | [**\OpenAPI\Client\CircuitID\Clients**](../Model/Clients.md)| The JSON object that will be posted to the REST API endpoint. | |
...
```php
patchClient($id, $clientsNotRequired): mixed
```
...
$id = NULL; // mixed | The ObjectId (unique 12 bytes ID) of record you would like to GET.
$clientsNotRequired = new \OpenAPI\Client\CircuitID\ClientsNotRequired(); // \OpenAPI\Client\CircuitID\ClientsNotRequired | The request data.

try {
    $result = $apiInstance->patchClient($id, $clientsNotRequired);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | [**mixed**](../Model/.md)| The ObjectId (unique 12 bytes ID) of record you would like to GET. | |
| **clientsNotRequired** | [**\OpenAPI\Client\CircuitID\ClientsNotRequired**](../Model/ClientsNotRequired.md)| The request data. | |
...
try {
    $result = $apiInstance->removeClient($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ClientsApi->removeClient: ', $e->getMessage(), PHP_EOL;
}
```
