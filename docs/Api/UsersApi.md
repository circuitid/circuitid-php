...
[**\OpenAPI\Client\CircuitID\GetUser200Response**](../Model/GetUser200Response.md)
...
```php
getUser($id): \OpenAPI\Client\CircuitID\GetUser200Response
```
...
```php
removeUser($id): \OpenAPI\Client\CircuitID\GetUser200Response
```
