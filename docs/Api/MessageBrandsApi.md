...
```php
createMessageBrand($messagebrands): mixed
```
...
$apiInstance = new OpenAPI\Client\Api\MessageBrandsApi(
...
try {
    $result = $apiInstance->getMessageBrand($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageBrandsApi->getMessageBrand: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
patchMessageBrand($id, $messagebrandsNotRequired): mixed
```
...
$id = NULL; // mixed | The ObjectId (unique 12 bytes ID) of record you would like to GET.
$messagebrandsNotRequired = new \OpenAPI\Client\CircuitID\MessagebrandsNotRequired(); // \OpenAPI\Client\CircuitID\MessagebrandsNotRequired | The request data.

try {
    $result = $apiInstance->patchMessageBrand($id, $messagebrandsNotRequired);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | [**mixed**](../Model/.md)| The ObjectId (unique 12 bytes ID) of record you would like to GET. | |
| **messagebrandsNotRequired** | [**\OpenAPI\Client\CircuitID\MessagebrandsNotRequired**](../Model/MessagebrandsNotRequired.md)| The request data. | |
...
try {
    $result = $apiInstance->removeMessageBrand($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageBrandsApi->removeMessageBrand: ', $e->getMessage(), PHP_EOL;
}
```
