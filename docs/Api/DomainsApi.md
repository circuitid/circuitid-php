...
[**\OpenAPI\Client\CircuitID\GetDomain200Response**](../Model/GetDomain200Response.md)
...
```php
getDomain($id): \OpenAPI\Client\CircuitID\GetDomain200Response
```
...
```php
removeDomain($id): \OpenAPI\Client\CircuitID\GetDomain200Response
```
