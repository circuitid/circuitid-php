...
```php
createPhoneInboundRuleAction($phoneinboundruleactions): \OpenAPI\Client\CircuitID\GetPhoneInboundRuleAction200Response
```
...
[**\OpenAPI\Client\CircuitID\GetPhoneInboundRuleAction200Response**](../Model/GetPhoneInboundRuleAction200Response.md)
...
```php
getPhoneInboundRuleAction($id): \OpenAPI\Client\CircuitID\GetPhoneInboundRuleAction200Response
```
...
```php
removePhoneInboundRuleAction($id): \OpenAPI\Client\CircuitID\GetPhoneInboundRuleAction200Response
```
