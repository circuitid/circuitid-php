...
[**\OpenAPI\Client\CircuitID\GetContact200Response**](../Model/GetContact200Response.md)
...
```php
getContact($id): \OpenAPI\Client\CircuitID\GetContact200Response
```
...
```php
removeContact($id): \OpenAPI\Client\CircuitID\GetContact200Response
```
