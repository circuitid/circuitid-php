...
[**\OpenAPI\Client\CircuitID\GetUserToken200Response**](../Model/GetUserToken200Response.md)
...
```php
getUserToken($id): \OpenAPI\Client\CircuitID\GetUserToken200Response
```
...
```php
removeUserToken($id): \OpenAPI\Client\CircuitID\GetUserToken200Response
```
