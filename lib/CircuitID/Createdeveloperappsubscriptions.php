...
/**
 * Createdeveloperappsubscriptions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Createdeveloperappsubscriptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createdeveloperappsubscriptions';
    ...
    */
    ...
    public function setRef($ref)
    {
        ...
        if ((mb_strlen($ref) > 45)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling Createdeveloperappsubscriptions., must be smaller than or equal to 45.');
        }
