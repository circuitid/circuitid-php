 ...
 */
class Createfaxes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createfaxes';
    ...
    */
    ...
    public function setError($error)
    {
        ...
        if ((mb_strlen($error) > 255)) {
            throw new \InvalidArgumentException('invalid length for $error when calling Createfaxes., must be smaller than or equal to 255.');
        }
    ...
    public function setSenderEmail($senderEmail)
    {
        ...
        if ((mb_strlen($senderEmail) > 45)) {
            throw new \InvalidArgumentException('invalid length for $senderEmail when calling Createfaxes., must be smaller than or equal to 45.');
        }
    ...
    public function setSenderName($senderName)
    {
        ...
        if ((mb_strlen($senderName) > 45)) {
            throw new \InvalidArgumentException('invalid length for $senderName when calling Createfaxes., must be smaller than or equal to 45.');
        }
