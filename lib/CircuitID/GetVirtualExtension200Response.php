...
/**
 * GetVirtualExtension200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetVirtualExtension200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getVirtualExtension_200_response';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GetVirtualExtension200Response., must be smaller than or equal to 45.');
        }
     ...
     *
     * @param string|null $phoneinboundrule ObjectId (unique 12 bytes ID)
     *
     * @return self
     */
