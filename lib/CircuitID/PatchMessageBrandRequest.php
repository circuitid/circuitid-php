...
/**
 * PatchMessageBrandRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchMessageBrandRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchMessageBrand_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['ein']) && (mb_strlen($this->container['ein']) > 20)) {
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchMessageBrandRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setBrandId($brandId)
    {
        ...
        if (!is_null($brandId) && (mb_strlen($brandId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $brandId when calling PatchMessageBrandRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setEin($ein)
    {
        ...
        if (!is_null($ein) && (mb_strlen($ein) > 20)) {
            throw new \InvalidArgumentException('invalid length for $ein when calling PatchMessageBrandRequest., must be smaller than or equal to 20.');
        }
    ...
    public function setBrandRelationship($brandRelationship)
    {
        ...
        if (!is_null($brandRelationship) && (mb_strlen($brandRelationship) > 45)) {
            throw new \InvalidArgumentException('invalid length for $brandRelationship when calling PatchMessageBrandRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setVertical($vertical)
    {
        ...
        if (!is_null($vertical) && (mb_strlen($vertical) > 45)) {
            throw new \InvalidArgumentException('invalid length for $vertical when calling PatchMessageBrandRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setEntityType($entityType)
    {
        ...
        if (!is_null($entityType) && (mb_strlen($entityType) > 45)) {
            throw new \InvalidArgumentException('invalid length for $entityType when calling PatchMessageBrandRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setCspId($cspId)
    {
        ...
        if (!is_null($cspId) && (mb_strlen($cspId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $cspId when calling PatchMessageBrandRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setEinIssuingCountry($einIssuingCountry)
    {
        ...
        if (!is_null($einIssuingCountry) && (mb_strlen($einIssuingCountry) > 2)) {
            throw new \InvalidArgumentException('invalid length for $einIssuingCountry when calling PatchMessageBrandRequest., must be smaller than or equal to 2.');
        }
    ...
    public function setUniversalEin($universalEin)
    {
        ...
        if (!is_null($universalEin) && (mb_strlen($universalEin) > 45)) {
            throw new \InvalidArgumentException('invalid length for $universalEin when calling PatchMessageBrandRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setReferenceId($referenceId)
    {
        ...
        if (!is_null($referenceId) && (mb_strlen($referenceId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $referenceId when calling PatchMessageBrandRequest., must be smaller than or equal to 45.');
        }
