...
/**
 * PatchOfficeRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchOfficeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchOffice_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['streetNumber']) && (mb_strlen($this->container['streetNumber']) > 45)) {
            $invalidProperties[] = "invalid value for 'streetNumber', the character length must be smaller than or equal to 45.";
        }

        if (!is_null($this->container['streetName']) && (mb_strlen($this->container['streetName']) > 20)) {
        ...
        if (!is_null($this->container['streetSuffix']) && (mb_strlen($this->container['streetSuffix']) > 4)) {
            $invalidProperties[] = "invalid value for 'streetSuffix', the character length must be smaller than or equal to 4.";
        }

        if (!is_null($this->container['streetSuffix']) && (mb_strlen($this->container['streetSuffix']) < 2)) {
            $invalidProperties[] = "invalid value for 'streetSuffix', the character length must be bigger than or equal to 2.";
        }

        if (!is_null($this->container['city']) && (mb_strlen($this->container['city']) > 45)) {
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchOfficeRequest., must be smaller than or equal to 45.');
        }
     ...
     * Sets streetNumber
     *
     * @param mixed|null $streetNumber streetNumber
     *
     * @return self
     */
    public function setStreetNumber($streetNumber)
    {
        ...
        if (!is_null($streetNumber) && (mb_strlen($streetNumber) > 45)) {
            throw new \InvalidArgumentException('invalid length for $streetNumber when calling PatchOfficeRequest., must be smaller than or equal to 45.');
        }
     ...
     * Sets streetName
     *
     * @param mixed|null $streetName streetName
     *
     * @return self
     */
    public function setStreetName($streetName)
    {
        ...
        if (!is_null($streetName) && (mb_strlen($streetName) > 20)) {
            throw new \InvalidArgumentException('invalid length for $streetName when calling PatchOfficeRequest., must be smaller than or equal to 20.');
        }
    ...
    public function setPreDirection($preDirection)
    {
        ...
        if (!is_null($preDirection) && (mb_strlen($preDirection) > 2)) {
            throw new \InvalidArgumentException('invalid length for $preDirection when calling PatchOfficeRequest., must be smaller than or equal to 2.');
        }
     ...
     * Sets streetSuffix
     *
     * @param mixed|null $streetSuffix streetSuffix
     *
     * @return self
     */
    public function setStreetSuffix($streetSuffix)
    {
        ...
        if (!is_null($streetSuffix) && (mb_strlen($streetSuffix) > 4)) {
            throw new \InvalidArgumentException('invalid length for $streetSuffix when calling PatchOfficeRequest., must be smaller than or equal to 4.');
        }
        if (!is_null($streetSuffix) && (mb_strlen($streetSuffix) < 2)) {
            throw new \InvalidArgumentException('invalid length for $streetSuffix when calling PatchOfficeRequest., must be bigger than or equal to 2.');
        }
    ...
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (mb_strlen($city) > 45)) {
            throw new \InvalidArgumentException('invalid length for $city when calling PatchOfficeRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setState($state)
    {
        ...
        if (!is_null($state) && (mb_strlen($state) > 45)) {
            throw new \InvalidArgumentException('invalid length for $state when calling PatchOfficeRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setZipCode($zipCode)
    {
        ...
        if (!is_null($zipCode) && (mb_strlen($zipCode) > 45)) {
            throw new \InvalidArgumentException('invalid length for $zipCode when calling PatchOfficeRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setAddress2($address2)
    {
        ...
        if (!is_null($address2) && (mb_strlen($address2) > 45)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling PatchOfficeRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling PatchOfficeRequest., must be smaller than or equal to 2.');
        }
        if (!is_null($country) && (mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling PatchOfficeRequest., must be bigger than or equal to 2.');
        }
