...
/**
 * UsersCommunicationValueNotifications Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UsersCommunicationValueNotifications implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'users_communication_value_notifications';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sms', $data ?? [], true);
