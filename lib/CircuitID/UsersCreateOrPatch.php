...
/**
 * UsersCreateOrPatch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UsersCreateOrPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'usersCreateOrPatch';
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UsersCreateOrPatch., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($email) < 5)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UsersCreateOrPatch., must be bigger than or equal to 5.');
        }
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) > 255)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UsersCreateOrPatch., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($password) < 8)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UsersCreateOrPatch., must be bigger than or equal to 8.');
        }
    ...
    public function setFirst($first)
    {
        ...
        if ((mb_strlen($first) > 45)) {
            throw new \InvalidArgumentException('invalid length for $first when calling UsersCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setLast($last)
    {
        ...
        if ((mb_strlen($last) > 45)) {
            throw new \InvalidArgumentException('invalid length for $last when calling UsersCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setMobilePhone($mobilePhone)
    {
        ...
        if ((mb_strlen($mobilePhone) > 20)) {
            throw new \InvalidArgumentException('invalid length for $mobilePhone when calling UsersCreateOrPatch., must be smaller than or equal to 20.');
        }
    ...
    public function setBusinessPhone($businessPhone)
    {
        ...
        if ((mb_strlen($businessPhone) > 20)) {
            throw new \InvalidArgumentException('invalid length for $businessPhone when calling UsersCreateOrPatch., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($businessPhone) < 7)) {
            throw new \InvalidArgumentException('invalid length for $businessPhone when calling UsersCreateOrPatch., must be bigger than or equal to 7.');
        }
    ...
    public function setJobTitle($jobTitle)
    {
        ...
        if ((mb_strlen($jobTitle) > 45)) {
            throw new \InvalidArgumentException('invalid length for $jobTitle when calling UsersCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setDepartment($department)
    {
        ...
        if ((mb_strlen($department) > 45)) {
            throw new \InvalidArgumentException('invalid length for $department when calling UsersCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setAvatar($avatar)
    {
        ...
        if ((mb_strlen($avatar) > 512)) {
            throw new \InvalidArgumentException('invalid length for $avatar when calling UsersCreateOrPatch., must be smaller than or equal to 512.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if ((mb_strlen($language) > 5)) {
            throw new \InvalidArgumentException('invalid length for $language when calling UsersCreateOrPatch., must be smaller than or equal to 5.');
        }
    ...
    public function setVmPlaybackNumber($vmPlaybackNumber)
    {
        ...
        if ((mb_strlen($vmPlaybackNumber) > 20)) {
            throw new \InvalidArgumentException('invalid length for $vmPlaybackNumber when calling UsersCreateOrPatch., must be smaller than or equal to 20.');
        }
    ...
    public function setCallerIdNumber($callerIdNumber)
    {
        ...
        if ((mb_strlen($callerIdNumber) > 20)) {
            throw new \InvalidArgumentException('invalid length for $callerIdNumber when calling UsersCreateOrPatch., must be smaller than or equal to 20.');
        }
    ...
    public function setTimezone($timezone)
    {
        ...
        if ((mb_strlen($timezone) > 45)) {
            throw new \InvalidArgumentException('invalid length for $timezone when calling UsersCreateOrPatch., must be smaller than or equal to 45.');
        }
