...
class PatchFirewallRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchFirewall_request';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchFirewallRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchFirewallRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setParam($param)
    {
        ...
        if (!is_null($param) && (mb_strlen($param) > 45)) {
            throw new \InvalidArgumentException('invalid length for $param when calling PatchFirewallRequest., must be smaller than or equal to 45.');
        }
        if (!is_null($param) && (mb_strlen($param) < 1)) {
            throw new \InvalidArgumentException('invalid length for $param when calling PatchFirewallRequest., must be bigger than or equal to 1.');
        }
