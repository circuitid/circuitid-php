...
/**
 * UsersNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UsersNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'usersNotRequired';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sipPassword']) && (mb_strlen($this->container['sipPassword']) > 45)) {
            $invalidProperties[] = "invalid value for 'sipPassword', the character length must be smaller than or equal to 45.";
        }

        if (!is_null($this->container['sipPassword']) && (mb_strlen($this->container['sipPassword']) < 8)) {
        ...
        if (!is_null($this->container['first']) && (mb_strlen($this->container['first']) > 45)) {
    ...
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UsersNotRequired., must be smaller than or equal to 255.');
        }
        if (!is_null($email) && (mb_strlen($email) < 5)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UsersNotRequired., must be bigger than or equal to 5.');
        }
    ...
    public function setPassword($password)
    {
        ...
        if (!is_null($password) && (mb_strlen($password) > 255)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UsersNotRequired., must be smaller than or equal to 255.');
        }
        if (!is_null($password) && (mb_strlen($password) < 8)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UsersNotRequired., must be bigger than or equal to 8.');
        }
     ...
     * Sets sipPassword
     *
     * @param mixed|null $sipPassword sipPassword
     *
     * @return self
     */
    public function setSipPassword($sipPassword)
    {
        ...
        if (!is_null($sipPassword) && (mb_strlen($sipPassword) > 45)) {
            throw new \InvalidArgumentException('invalid length for $sipPassword when calling UsersNotRequired., must be smaller than or equal to 45.');
        }
        if (!is_null($sipPassword) && (mb_strlen($sipPassword) < 8)) {
            throw new \InvalidArgumentException('invalid length for $sipPassword when calling UsersNotRequired., must be bigger than or equal to 8.');
        }
    ...
    public function setTurnPassword($turnPassword)
    {
        ...
        if (!is_null($turnPassword) && (mb_strlen($turnPassword) > 45)) {
            throw new \InvalidArgumentException('invalid length for $turnPassword when calling UsersNotRequired., must be smaller than or equal to 45.');
        }
        if (!is_null($turnPassword) && (mb_strlen($turnPassword) < 8)) {
            throw new \InvalidArgumentException('invalid length for $turnPassword when calling UsersNotRequired., must be bigger than or equal to 8.');
        }
    ...
    public function setFirst($first)
    {
        ...
        if (!is_null($first) && (mb_strlen($first) > 45)) {
            throw new \InvalidArgumentException('invalid length for $first when calling UsersNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setLast($last)
    {
        ...
        if (!is_null($last) && (mb_strlen($last) > 45)) {
            throw new \InvalidArgumentException('invalid length for $last when calling UsersNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setMobilePhone($mobilePhone)
    {
        ...
        if (!is_null($mobilePhone) && (mb_strlen($mobilePhone) > 20)) {
            throw new \InvalidArgumentException('invalid length for $mobilePhone when calling UsersNotRequired., must be smaller than or equal to 20.');
        }
    ...
    public function setBusinessPhone($businessPhone)
    {
        ...
        if (!is_null($businessPhone) && (mb_strlen($businessPhone) > 20)) {
            throw new \InvalidArgumentException('invalid length for $businessPhone when calling UsersNotRequired., must be smaller than or equal to 20.');
        }
        if (!is_null($businessPhone) && (mb_strlen($businessPhone) < 7)) {
            throw new \InvalidArgumentException('invalid length for $businessPhone when calling UsersNotRequired., must be bigger than or equal to 7.');
        }
    ...
    public function setJobTitle($jobTitle)
    {
        ...
        if (!is_null($jobTitle) && (mb_strlen($jobTitle) > 45)) {
            throw new \InvalidArgumentException('invalid length for $jobTitle when calling UsersNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setDepartment($department)
    {
        ...
        if (!is_null($department) && (mb_strlen($department) > 45)) {
            throw new \InvalidArgumentException('invalid length for $department when calling UsersNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setAvatar($avatar)
    {
        ...
        if (!is_null($avatar) && (mb_strlen($avatar) > 255)) {
            throw new \InvalidArgumentException('invalid length for $avatar when calling UsersNotRequired., must be smaller than or equal to 255.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if (!is_null($language) && (mb_strlen($language) > 5)) {
            throw new \InvalidArgumentException('invalid length for $language when calling UsersNotRequired., must be smaller than or equal to 5.');
        }
    ...
    public function setVmPlaybackNumber($vmPlaybackNumber)
    {
        ...
        if (!is_null($vmPlaybackNumber) && (mb_strlen($vmPlaybackNumber) > 20)) {
            throw new \InvalidArgumentException('invalid length for $vmPlaybackNumber when calling UsersNotRequired., must be smaller than or equal to 20.');
        }
    ...
    public function setCallerIdNumber($callerIdNumber)
    {
        ...
        if (!is_null($callerIdNumber) && (mb_strlen($callerIdNumber) > 20)) {
            throw new \InvalidArgumentException('invalid length for $callerIdNumber when calling UsersNotRequired., must be smaller than or equal to 20.');
        }
