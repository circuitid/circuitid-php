...
/**
 * PatchServerRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchServerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchServer_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['host']) && (mb_strlen($this->container['host']) > 45)) {
            $invalidProperties[] = "invalid value for 'host', the character length must be smaller than or equal to 45.";
        }

        if (!is_null($this->container['host']) && (mb_strlen($this->container['host']) < 5)) {
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchServerRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setHost($host)
    {
        ...
        if (!is_null($host) && (mb_strlen($host) > 45)) {
            throw new \InvalidArgumentException('invalid length for $host when calling PatchServerRequest., must be smaller than or equal to 45.');
        }
        if (!is_null($host) && (mb_strlen($host) < 5)) {
            throw new \InvalidArgumentException('invalid length for $host when calling PatchServerRequest., must be bigger than or equal to 5.');
        }
    ...
    public function setCallerId($callerId)
    {
        ...
        if (!is_null($callerId) && (mb_strlen($callerId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callerId when calling PatchServerRequest., must be smaller than or equal to 45.');
        }
     ...
     *
     * @param mixed|null $domesticOutboundCallLimit domesticOutboundCallLimit
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $domesticInboundCallLimit domesticInboundCallLimit
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $internationalOutboundCallLimit internationalOutboundCallLimit
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $tollFreeChannelLimit tollFreeChannelLimit
     *
     * @return self
     */
