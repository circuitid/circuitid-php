...
/**
 * GetUserToken200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetUserToken200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getUserToken_200_response';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GetUserToken200Response., must be smaller than or equal to 45.');
        }
    ...
    public function setToken($token)
    {
        ...
        if ((mb_strlen($token) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $token when calling GetUserToken200Response., must be smaller than or equal to 2048.');
        }
     ...
     * Sets expiresInYears
     *
     * @param int $expiresInYears expiresInYears
     *
     * @return self
     */
    public function setExpiresInYears($expiresInYears)
    {
        if (is_null($expiresInYears)) {
            throw new \InvalidArgumentException('non-nullable expiresInYears cannot be null');
        }
