...
/**
 * MessagecampaignsNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagecampaignsNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'messagecampaignsNotRequired';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling MessagecampaignsNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setCampaignId($campaignId)
    {
        ...
        if (!is_null($campaignId) && (mb_strlen($campaignId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $campaignId when calling MessagecampaignsNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setBrandId($brandId)
    {
        ...
        if (!is_null($brandId) && (mb_strlen($brandId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $brandId when calling MessagecampaignsNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setReferenceId($referenceId)
    {
        ...
        if (!is_null($referenceId) && (mb_strlen($referenceId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $referenceId when calling MessagecampaignsNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setUseCase($useCase)
    {
        ...
        if (!is_null($useCase) && (mb_strlen($useCase) > 45)) {
            throw new \InvalidArgumentException('invalid length for $useCase when calling MessagecampaignsNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setSample1($sample1)
    {
        ...
        if (!is_null($sample1) && (mb_strlen($sample1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sample1 when calling MessagecampaignsNotRequired., must be smaller than or equal to 255.');
        }
    ...
    public function setSample2($sample2)
    {
        ...
        if (!is_null($sample2) && (mb_strlen($sample2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sample2 when calling MessagecampaignsNotRequired., must be smaller than or equal to 255.');
        }
    ...
    public function setSample3($sample3)
    {
        ...
        if (!is_null($sample3) && (mb_strlen($sample3) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sample3 when calling MessagecampaignsNotRequired., must be smaller than or equal to 255.');
        }
    ...
    public function setSample4($sample4)
    {
        ...
        if (!is_null($sample4) && (mb_strlen($sample4) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sample4 when calling MessagecampaignsNotRequired., must be smaller than or equal to 255.');
        }
    ...
    public function setSample5($sample5)
    {
        ...
        if (!is_null($sample5) && (mb_strlen($sample5) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sample5 when calling MessagecampaignsNotRequired., must be smaller than or equal to 255.');
        }
