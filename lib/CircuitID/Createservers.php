...
/**
 * Createservers Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Createservers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Createservers., must be smaller than or equal to 45.');
        }
    ...
    public function setHost($host)
    {
        ...
        if ((mb_strlen($host) > 45)) {
            throw new \InvalidArgumentException('invalid length for $host when calling Createservers., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($host) < 5)) {
            throw new \InvalidArgumentException('invalid length for $host when calling Createservers., must be bigger than or equal to 5.');
        }
    ...
    public function setCallerId($callerId)
    {
        ...
        if ((mb_strlen($callerId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callerId when calling Createservers., must be smaller than or equal to 45.');
        }
