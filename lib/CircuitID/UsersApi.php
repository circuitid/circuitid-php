...
/**
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\CircuitID\FindUsers200Response
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\CircuitID\FindUsers200Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  mixed $id The ObjectId (unique 12 bytes ID) of record you would like to GET. (required)
     * @param  \OpenAPI\Client\CircuitID\UsersNotRequired $usersNotRequired The request data. (required)
     ...
     * @return mixed
     */
    public function patchUser($id, $usersNotRequired, string $contentType = self::contentTypes['patchUser'][0])
    {
        list($response) = $this->patchUserWithHttpInfo($id, $usersNotRequired, $contentType);
        return $response;
    }
     ...
     * @return array of mixed, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchUserWithHttpInfo($id, $usersNotRequired, string $contentType = self::contentTypes['patchUser'][0])
    {
        $request = $this->patchUserRequest($id, $usersNotRequired, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchUserAsync($id, $usersNotRequired, string $contentType = self::contentTypes['patchUser'][0])
    {
        return $this->patchUserAsyncWithHttpInfo($id, $usersNotRequired, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchUserAsyncWithHttpInfo($id, $usersNotRequired, string $contentType = self::contentTypes['patchUser'][0])
    {
        $returnType = 'mixed';
        $request = $this->patchUserRequest($id, $usersNotRequired, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchUserRequest($id, $usersNotRequired, string $contentType = self::contentTypes['patchUser'][0])
    {
        ...
        // verify the required parameter 'usersNotRequired' is set
        if ($usersNotRequired === null || (is_array($usersNotRequired) && count($usersNotRequired) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $usersNotRequired when calling patchUser'
            );
        }
        ...
        // for model (json/xml)
        if (isset($usersNotRequired)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($usersNotRequired));
            } else {
                $httpBody = $usersNotRequired;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
