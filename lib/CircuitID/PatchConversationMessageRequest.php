...
/**
 * PatchConversationMessageRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchConversationMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchConversationMessage_request';
    ...
    */
    ...
    public function setFromNumber($fromNumber)
    {
        ...
        if (!is_null($fromNumber) && (mb_strlen($fromNumber) > 40)) {
            throw new \InvalidArgumentException('invalid length for $fromNumber when calling PatchConversationMessageRequest., must be smaller than or equal to 40.');
        }
    ...
    public function setText($text)
    {
        ...
        if (!is_null($text) && (mb_strlen($text) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $text when calling PatchConversationMessageRequest., must be smaller than or equal to 2048.');
        }
    ...
    public function setReferenceId($referenceId)
    {
        ...
        if (!is_null($referenceId) && (mb_strlen($referenceId) > 255)) {
            throw new \InvalidArgumentException('invalid length for $referenceId when calling PatchConversationMessageRequest., must be smaller than or equal to 255.');
        }
