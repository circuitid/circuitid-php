...
/**
 * Createnumbers Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Createnumbers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createnumbers';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 20)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Createnumbers., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($name) < 10)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Createnumbers., must be bigger than or equal to 10.');
        }
    ...
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) > 4)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling Createnumbers., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($countryCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling Createnumbers., must be bigger than or equal to 1.');
        }
    ...
    public function setProviderOrderId($providerOrderId)
    {
        ...
        if ((mb_strlen($providerOrderId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $providerOrderId when calling Createnumbers., must be smaller than or equal to 45.');
        }
    ...
    public function setChangeRegionOrderId($changeRegionOrderId)
    {
        ...
        if ((mb_strlen($changeRegionOrderId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $changeRegionOrderId when calling Createnumbers., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($changeRegionOrderId) < 5)) {
            throw new \InvalidArgumentException('invalid length for $changeRegionOrderId when calling Createnumbers., must be bigger than or equal to 5.');
        }
    ...
    public function setDirectoryListingOrderId($directoryListingOrderId)
    {
        ...
        if ((mb_strlen($directoryListingOrderId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $directoryListingOrderId when calling Createnumbers., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($directoryListingOrderId) < 5)) {
            throw new \InvalidArgumentException('invalid length for $directoryListingOrderId when calling Createnumbers., must be bigger than or equal to 5.');
        }
    ...
    public function setCallerName($callerName)
    {
        ...
        if ((mb_strlen($callerName) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callerName when calling Createnumbers., must be smaller than or equal to 45.');
        }
    ...
    public function setCallerNameOrderId($callerNameOrderId)
    {
        ...
        if ((mb_strlen($callerNameOrderId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callerNameOrderId when calling Createnumbers., must be smaller than or equal to 45.');
        }
    ...
    public function setE911OrderId($e911OrderId)
    {
        ...
        if ((mb_strlen($e911OrderId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $e911OrderId when calling Createnumbers., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($e911OrderId) < 5)) {
            throw new \InvalidArgumentException('invalid length for $e911OrderId when calling Createnumbers., must be bigger than or equal to 5.');
        }
    ...
    public function setMessageCampaign($messageCampaign)
    {
        ...
        if ((mb_strlen($messageCampaign) > 45)) {
            throw new \InvalidArgumentException('invalid length for $messageCampaign when calling Createnumbers., must be smaller than or equal to 45.');
        }
    ...
    public function setMessageCampaignOrderId($messageCampaignOrderId)
    {
        ...
        if ((mb_strlen($messageCampaignOrderId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $messageCampaignOrderId when calling Createnumbers., must be smaller than or equal to 45.');
        }
    ...
    public function setRef($ref)
    {
        ...
        if ((mb_strlen($ref) > 100)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling Createnumbers., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($ref) < 5)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling Createnumbers., must be bigger than or equal to 5.');
        }
    ...
    public function setCallForwardingDestination($callForwardingDestination)
    {
        ...
        if ((mb_strlen($callForwardingDestination) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callForwardingDestination when calling Createnumbers., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($callForwardingDestination) < 10)) {
            throw new \InvalidArgumentException('invalid length for $callForwardingDestination when calling Createnumbers., must be bigger than or equal to 10.');
        }
