...
/**
 * ContactsNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContactsNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'contactsNotRequired';
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 45)) {
            throw new \InvalidArgumentException('invalid length for $email when calling ContactsNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setFirst($first)
    {
        ...
        if (!is_null($first) && (mb_strlen($first) > 45)) {
            throw new \InvalidArgumentException('invalid length for $first when calling ContactsNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setLast($last)
    {
        ...
        if (!is_null($last) && (mb_strlen($last) > 45)) {
            throw new \InvalidArgumentException('invalid length for $last when calling ContactsNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setMobilePhone($mobilePhone)
    {
        ...
        if (!is_null($mobilePhone) && (mb_strlen($mobilePhone) > 20)) {
            throw new \InvalidArgumentException('invalid length for $mobilePhone when calling ContactsNotRequired., must be smaller than or equal to 20.');
        }
    ...
    public function setBusinessPhone($businessPhone)
    {
        ...
        if (!is_null($businessPhone) && (mb_strlen($businessPhone) > 20)) {
            throw new \InvalidArgumentException('invalid length for $businessPhone when calling ContactsNotRequired., must be smaller than or equal to 20.');
        }
    ...
    public function setFaxPhone($faxPhone)
    {
        ...
        if (!is_null($faxPhone) && (mb_strlen($faxPhone) > 20)) {
            throw new \InvalidArgumentException('invalid length for $faxPhone when calling ContactsNotRequired., must be smaller than or equal to 20.');
        }
    ...
    public function setJobTitle($jobTitle)
    {
        ...
        if (!is_null($jobTitle) && (mb_strlen($jobTitle) > 45)) {
            throw new \InvalidArgumentException('invalid length for $jobTitle when calling ContactsNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setDepartment($department)
    {
        ...
        if (!is_null($department) && (mb_strlen($department) > 45)) {
            throw new \InvalidArgumentException('invalid length for $department when calling ContactsNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setAvatar($avatar)
    {
        ...
        if (!is_null($avatar) && (mb_strlen($avatar) > 255)) {
            throw new \InvalidArgumentException('invalid length for $avatar when calling ContactsNotRequired., must be smaller than or equal to 255.');
        }
