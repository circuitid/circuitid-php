...
/**
 * RatecentersCreateOrPatch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RatecentersCreateOrPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ratecentersCreateOrPatch';
    ...
    */
    ...
    public function setNpa($npa)
    {
        ...
        if ((mb_strlen($npa) > 3)) {
            throw new \InvalidArgumentException('invalid length for $npa when calling RatecentersCreateOrPatch., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($npa) < 3)) {
            throw new \InvalidArgumentException('invalid length for $npa when calling RatecentersCreateOrPatch., must be bigger than or equal to 3.');
        }
    ...
    public function setNxx($nxx)
    {
        ...
        if ((mb_strlen($nxx) > 3)) {
            throw new \InvalidArgumentException('invalid length for $nxx when calling RatecentersCreateOrPatch., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($nxx) < 3)) {
            throw new \InvalidArgumentException('invalid length for $nxx when calling RatecentersCreateOrPatch., must be bigger than or equal to 3.');
        }
    ...
    public function setLata($lata)
    {
        ...
        if ((mb_strlen($lata) > 3)) {
            throw new \InvalidArgumentException('invalid length for $lata when calling RatecentersCreateOrPatch., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($lata) < 3)) {
            throw new \InvalidArgumentException('invalid length for $lata when calling RatecentersCreateOrPatch., must be bigger than or equal to 3.');
        }
    ...
    public function setLocState($locState)
    {
        ...
        if ((mb_strlen($locState) > 2)) {
            throw new \InvalidArgumentException('invalid length for $locState when calling RatecentersCreateOrPatch., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($locState) < 2)) {
            throw new \InvalidArgumentException('invalid length for $locState when calling RatecentersCreateOrPatch., must be bigger than or equal to 2.');
        }
    ...
    public function setRcAbbre($rcAbbre)
    {
        ...
        if ((mb_strlen($rcAbbre) > 45)) {
            throw new \InvalidArgumentException('invalid length for $rcAbbre when calling RatecentersCreateOrPatch., must be smaller than or equal to 45.');
        }
