...
class FindPhoneInboundRuleActions200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'limit' => 'int',
        'skip' => 'int',
        'data' => '\OpenAPI\Client\CircuitID\Phoneinboundruleactions[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\CircuitID\Phoneinboundruleactions[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\CircuitID\Phoneinboundruleactions[] $data data
     *
     * @return self
     */
