...
/**
 * MessagecampaignsCreateOrPatch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagecampaignsCreateOrPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'messagecampaignsCreateOrPatch';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling MessagecampaignsCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setCampaignId($campaignId)
    {
        ...
        if ((mb_strlen($campaignId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $campaignId when calling MessagecampaignsCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setBrandId($brandId)
    {
        ...
        if ((mb_strlen($brandId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $brandId when calling MessagecampaignsCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setReferenceId($referenceId)
    {
        ...
        if ((mb_strlen($referenceId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $referenceId when calling MessagecampaignsCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setUseCase($useCase)
    {
        ...
        if ((mb_strlen($useCase) > 45)) {
            throw new \InvalidArgumentException('invalid length for $useCase when calling MessagecampaignsCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setSample1($sample1)
    {
        ...
        if ((mb_strlen($sample1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sample1 when calling MessagecampaignsCreateOrPatch., must be smaller than or equal to 255.');
        }
    ...
    public function setSample2($sample2)
    {
        ...
        if ((mb_strlen($sample2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sample2 when calling MessagecampaignsCreateOrPatch., must be smaller than or equal to 255.');
        }
    ...
    public function setSample3($sample3)
    {
        ...
        if ((mb_strlen($sample3) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sample3 when calling MessagecampaignsCreateOrPatch., must be smaller than or equal to 255.');
        }
    ...
    public function setSample4($sample4)
    {
        ...
        if ((mb_strlen($sample4) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sample4 when calling MessagecampaignsCreateOrPatch., must be smaller than or equal to 255.');
        }
    ...
    public function setSample5($sample5)
    {
        ...
        if ((mb_strlen($sample5) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sample5 when calling MessagecampaignsCreateOrPatch., must be smaller than or equal to 255.');
        }
