...
/**
 * PatchChatRoomRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchChatRoomRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchChatRoom_request';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchChatRoomRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setAvatar($avatar)
    {
        ...
        if (!is_null($avatar) && (mb_strlen($avatar) > 512)) {
            throw new \InvalidArgumentException('invalid length for $avatar when calling PatchChatRoomRequest., must be smaller than or equal to 512.');
        }
     ...
     * Sets direct
     *
     * @param mixed|null $direct direct
     *
     * @return self
     */
    ...
    {
        if (is_null($direct)) {
            array_push($this->openAPINullablesSetToNull, 'direct');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('direct', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $allowedValues = $this->getDirectAllowableValues();
        if (!is_null($direct) && !in_array($direct, $allowedValues, true)) {
