<?php
/**
 * PhoneoutboundruleactionsNotRequired
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PhoneoutboundruleactionsNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PhoneoutboundruleactionsNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'phoneoutboundruleactionsNotRequired';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PhoneoutboundruleactionsNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setStartingChars($startingChars)
    {
        ...
        if (!is_null($startingChars) && (mb_strlen($startingChars) > 20)) {
            throw new \InvalidArgumentException('invalid length for $startingChars when calling PhoneoutboundruleactionsNotRequired., must be smaller than or equal to 20.');
        }
    ...
    public function setContains($contains)
    {
        ...
        if (!is_null($contains) && (mb_strlen($contains) > 20)) {
            throw new \InvalidArgumentException('invalid length for $contains when calling PhoneoutboundruleactionsNotRequired., must be smaller than or equal to 20.');
        }
    ...
    public function setAppendChars($appendChars)
    {
        ...
        if (!is_null($appendChars) && (mb_strlen($appendChars) > 20)) {
            throw new \InvalidArgumentException('invalid length for $appendChars when calling PhoneoutboundruleactionsNotRequired., must be smaller than or equal to 20.');
        }
    ...
    public function setPrependChars($prependChars)
    {
        ...
        if (!is_null($prependChars) && (mb_strlen($prependChars) > 20)) {
            throw new \InvalidArgumentException('invalid length for $prependChars when calling PhoneoutboundruleactionsNotRequired., must be smaller than or equal to 20.');
        }
