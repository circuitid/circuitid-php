...
/**
 * Createconferencerooms Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Createconferencerooms implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createconferencerooms';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Createconferencerooms., must be smaller than or equal to 45.');
        }
    ...
    public function setPasscode($passcode)
    {
        ...
        if ((mb_strlen($passcode) > 20)) {
            throw new \InvalidArgumentException('invalid length for $passcode when calling Createconferencerooms., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($passcode) < 6)) {
            throw new \InvalidArgumentException('invalid length for $passcode when calling Createconferencerooms., must be bigger than or equal to 6.');
        }
