...
/**
 * GetLicense200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetLicense200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getLicense_200_response';
    ...
    */
    ...
    public function setRef($ref)
    {
        ...
        if ((mb_strlen($ref) > 45)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling GetLicense200Response., must be smaller than or equal to 45.');
        }
    ...
    public function setField($field)
    {
        ...
        if ((mb_strlen($field) > 45)) {
            throw new \InvalidArgumentException('invalid length for $field when calling GetLicense200Response., must be smaller than or equal to 45.');
        }
