...
/**
 * ConversationmessagesCreateOrPatch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConversationmessagesCreateOrPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'conversationmessagesCreateOrPatch';
    ...
    */
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $text when calling ConversationmessagesCreateOrPatch., must be smaller than or equal to 2048.');
        }
