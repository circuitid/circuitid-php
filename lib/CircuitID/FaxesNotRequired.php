...
/**
 * FaxesNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FaxesNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'faxesNotRequired';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['callerIdNumber']) && (mb_strlen($this->container['callerIdNumber']) > 45)) {
            $invalidProperties[] = "invalid value for 'callerIdNumber', the character length must be smaller than or equal to 45.";
        }

        if (!is_null($this->container['callerDestination']) && (mb_strlen($this->container['callerDestination']) > 45)) {
    ...
    public function setCallerIdNumber($callerIdNumber)
    {
        ...
        if (!is_null($callerIdNumber) && (mb_strlen($callerIdNumber) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callerIdNumber when calling FaxesNotRequired., must be smaller than or equal to 45.');
        }
     ...
     *
     * @param mixed|null $callerDestination callerDestination
     *
     * @return self
     */
    public function setCallerDestination($callerDestination)
    {
        ...
        if (!is_null($callerDestination) && (mb_strlen($callerDestination) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callerDestination when calling FaxesNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setError($error)
    {
        ...
        if (!is_null($error) && (mb_strlen($error) > 255)) {
            throw new \InvalidArgumentException('invalid length for $error when calling FaxesNotRequired., must be smaller than or equal to 255.');
        }
     ...
     * Sets faxAccount
     *
     * @param mixed|null $faxAccount ObjectId (unique 12 bytes ID)
     *
     * @return self
     */
    ...
    public function setSenderEmail($senderEmail)
    {
        ...
        if (!is_null($senderEmail) && (mb_strlen($senderEmail) > 45)) {
            throw new \InvalidArgumentException('invalid length for $senderEmail when calling FaxesNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setSenderName($senderName)
    {
        ...
        if (!is_null($senderName) && (mb_strlen($senderName) > 45)) {
            throw new \InvalidArgumentException('invalid length for $senderName when calling FaxesNotRequired., must be smaller than or equal to 45.');
        }
