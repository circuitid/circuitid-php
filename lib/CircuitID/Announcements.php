...
/**
 * Announcements Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Announcements implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'announcements';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Announcements., must be smaller than or equal to 45.');
        }
    ...
    public function setText($text)
    {
        ...
        if (!is_null($text) && (mb_strlen($text) > 255)) {
            throw new \InvalidArgumentException('invalid length for $text when calling Announcements., must be smaller than or equal to 255.');
        }
        if (!is_null($text) && (mb_strlen($text) < 2)) {
            throw new \InvalidArgumentException('invalid length for $text when calling Announcements., must be bigger than or equal to 2.');
        }
