...
/**
 * PatchAcceptedSenderRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchAcceptedSenderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchAcceptedSender_request';
    ...
    */
     ...
     * Sets service
     *
     * @param mixed|null $service ObjectId (unique 12 bytes ID)
     *
     * @return self
     */
     ...
     * Sets serviceRef
     *
     * @param mixed|null $serviceRef serviceRef
     *
     * @return self
     */
