...
/**
 * PatchTimeScheduleRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchTimeScheduleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchTimeSchedule_request';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchTimeScheduleRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setTimezone($timezone)
    {
        ...
        if (!is_null($timezone) && (mb_strlen($timezone) > 45)) {
            throw new \InvalidArgumentException('invalid length for $timezone when calling PatchTimeScheduleRequest., must be smaller than or equal to 45.');
        }
