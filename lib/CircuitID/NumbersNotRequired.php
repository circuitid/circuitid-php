...
/**
 * NumbersNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NumbersNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'numbersNotRequired';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 20)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NumbersNotRequired., must be smaller than or equal to 20.');
        }
        if (!is_null($name) && (mb_strlen($name) < 10)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NumbersNotRequired., must be bigger than or equal to 10.');
        }
    ...
    public function setCountryCode($countryCode)
    {
        ...
        if (!is_null($countryCode) && (mb_strlen($countryCode) > 4)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling NumbersNotRequired., must be smaller than or equal to 4.');
        }
        if (!is_null($countryCode) && (mb_strlen($countryCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling NumbersNotRequired., must be bigger than or equal to 1.');
        }
    ...
    public function setProviderOrderId($providerOrderId)
    {
        ...
        if (!is_null($providerOrderId) && (mb_strlen($providerOrderId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $providerOrderId when calling NumbersNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setChangeRegionOrderId($changeRegionOrderId)
    {
        ...
        if (!is_null($changeRegionOrderId) && (mb_strlen($changeRegionOrderId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $changeRegionOrderId when calling NumbersNotRequired., must be smaller than or equal to 45.');
        }
        if (!is_null($changeRegionOrderId) && (mb_strlen($changeRegionOrderId) < 5)) {
            throw new \InvalidArgumentException('invalid length for $changeRegionOrderId when calling NumbersNotRequired., must be bigger than or equal to 5.');
        }
    ...
    public function setDirectoryListingOrderId($directoryListingOrderId)
    {
        ...
        if (!is_null($directoryListingOrderId) && (mb_strlen($directoryListingOrderId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $directoryListingOrderId when calling NumbersNotRequired., must be smaller than or equal to 45.');
        }
        if (!is_null($directoryListingOrderId) && (mb_strlen($directoryListingOrderId) < 5)) {
            throw new \InvalidArgumentException('invalid length for $directoryListingOrderId when calling NumbersNotRequired., must be bigger than or equal to 5.');
        }
    ...
    public function setCallerName($callerName)
    {
        ...
        if (!is_null($callerName) && (mb_strlen($callerName) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callerName when calling NumbersNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setCallerNameOrderId($callerNameOrderId)
    {
        ...
        if (!is_null($callerNameOrderId) && (mb_strlen($callerNameOrderId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callerNameOrderId when calling NumbersNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setE911OrderId($e911OrderId)
    {
        ...
        if (!is_null($e911OrderId) && (mb_strlen($e911OrderId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $e911OrderId when calling NumbersNotRequired., must be smaller than or equal to 45.');
        }
        if (!is_null($e911OrderId) && (mb_strlen($e911OrderId) < 5)) {
            throw new \InvalidArgumentException('invalid length for $e911OrderId when calling NumbersNotRequired., must be bigger than or equal to 5.');
        }
    ...
    public function setMessageCampaign($messageCampaign)
    {
        ...
        if (!is_null($messageCampaign) && (mb_strlen($messageCampaign) > 45)) {
            throw new \InvalidArgumentException('invalid length for $messageCampaign when calling NumbersNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setMessageCampaignOrderId($messageCampaignOrderId)
    {
        ...
        if (!is_null($messageCampaignOrderId) && (mb_strlen($messageCampaignOrderId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $messageCampaignOrderId when calling NumbersNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setRef($ref)
    {
        ...
        if (!is_null($ref) && (mb_strlen($ref) > 100)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling NumbersNotRequired., must be smaller than or equal to 100.');
        }
        if (!is_null($ref) && (mb_strlen($ref) < 5)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling NumbersNotRequired., must be bigger than or equal to 5.');
        }
    ...
    public function setCallForwardingDestination($callForwardingDestination)
    {
        ...
        if (!is_null($callForwardingDestination) && (mb_strlen($callForwardingDestination) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callForwardingDestination when calling NumbersNotRequired., must be smaller than or equal to 45.');
        }
        if (!is_null($callForwardingDestination) && (mb_strlen($callForwardingDestination) < 10)) {
            throw new \InvalidArgumentException('invalid length for $callForwardingDestination when calling NumbersNotRequired., must be bigger than or equal to 10.');
        }
