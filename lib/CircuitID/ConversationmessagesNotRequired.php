<?php
/**
 * ConversationmessagesNotRequired
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ConversationmessagesNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConversationmessagesNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'conversationmessagesNotRequired';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['fromNumber']) && (mb_strlen($this->container['fromNumber']) > 40)) {
     ...
     * Sets fromNumber
     *
     * @param mixed|null $fromNumber fromNumber
     *
     * @return self
     */
    public function setFromNumber($fromNumber)
    {
        ...
        if (!is_null($fromNumber) && (mb_strlen($fromNumber) > 40)) {
            throw new \InvalidArgumentException('invalid length for $fromNumber when calling ConversationmessagesNotRequired., must be smaller than or equal to 40.');
        }
    ...
    public function setText($text)
    {
        ...
        if (!is_null($text) && (mb_strlen($text) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $text when calling ConversationmessagesNotRequired., must be smaller than or equal to 2048.');
        }
    ...
    public function setReferenceId($referenceId)
    {
        ...
        if (!is_null($referenceId) && (mb_strlen($referenceId) > 255)) {
            throw new \InvalidArgumentException('invalid length for $referenceId when calling ConversationmessagesNotRequired., must be smaller than or equal to 255.');
        }
