...
/**
 * PatchPhoneInboundRuleActionRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchPhoneInboundRuleActionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchPhoneInbound_Rule_Action_request';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchPhoneInboundRuleActionRequest., must be smaller than or equal to 45.');
        }
     ...
     *
     * @param mixed|null $phoneinboundrule ObjectId (unique 12 bytes ID)
     *
     * @return self
     */
    public function setPhoneinboundrule($phoneinboundrule)
    {
        if (is_null($phoneinboundrule)) {
            array_push($this->openAPINullablesSetToNull, 'phoneinboundrule');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('phoneinboundrule', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setRef($ref)
    {
        ...
        if (!is_null($ref) && (mb_strlen($ref) > 100)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling PatchPhoneInboundRuleActionRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($ref) && (mb_strlen($ref) < 5)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling PatchPhoneInboundRuleActionRequest., must be bigger than or equal to 5.');
        }
    ...
    public function setCallForwardingDestination($callForwardingDestination)
    {
        ...
        if (!is_null($callForwardingDestination) && (mb_strlen($callForwardingDestination) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callForwardingDestination when calling PatchPhoneInboundRuleActionRequest., must be smaller than or equal to 45.');
        }
        if (!is_null($callForwardingDestination) && (mb_strlen($callForwardingDestination) < 10)) {
            throw new \InvalidArgumentException('invalid length for $callForwardingDestination when calling PatchPhoneInboundRuleActionRequest., must be bigger than or equal to 10.');
        }
