...
/**
 * UsertokensNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UsertokensNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'usertokensNotRequired';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('expiresInYears', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['token']) && (mb_strlen($this->container['token']) > 2048)) {
            $invalidProperties[] = "invalid value for 'token', the character length must be smaller than or equal to 2048.";
        }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UsertokensNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setToken($token)
    {
        ...
        if (!is_null($token) && (mb_strlen($token) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $token when calling UsertokensNotRequired., must be smaller than or equal to 2048.');
        }
     ...
     * @return mixed|null
     */
    public function getExpiresInYears()
    {
        return $this->container['expiresInYears'];
    }

    /**
     * Sets expiresInYears
     *
     * @param mixed|null $expiresInYears expiresInYears
     *
     * @return self
     */
    public function setExpiresInYears($expiresInYears)
    {
        if (is_null($expiresInYears)) {
            array_push($this->openAPINullablesSetToNull, 'expiresInYears');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('expiresInYears', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['expiresInYears'] = $expiresInYears;
