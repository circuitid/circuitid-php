...
/**
 * Createfirewall Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Createfirewall implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createfirewall';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Createfirewall., must be smaller than or equal to 45.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Createfirewall., must be smaller than or equal to 255.');
        }
    ...
    public function setParam($param)
    {
        ...
        if ((mb_strlen($param) > 45)) {
            throw new \InvalidArgumentException('invalid length for $param when calling Createfirewall., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($param) < 1)) {
            throw new \InvalidArgumentException('invalid length for $param when calling Createfirewall., must be bigger than or equal to 1.');
        }
