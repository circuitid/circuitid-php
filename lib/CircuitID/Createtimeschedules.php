...
/**
 * Createtimeschedules Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Createtimeschedules implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createtimeschedules';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Createtimeschedules., must be smaller than or equal to 45.');
        }
    ...
    public function setTimezone($timezone)
    {
        ...
        if ((mb_strlen($timezone) > 45)) {
            throw new \InvalidArgumentException('invalid length for $timezone when calling Createtimeschedules., must be smaller than or equal to 45.');
        }
