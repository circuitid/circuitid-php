...
/**
 * Createmessagebrands Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Createmessagebrands implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createmessagebrands';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Createmessagebrands., must be smaller than or equal to 45.');
        }
    ...
    public function setBrandId($brandId)
    {
        ...
        if ((mb_strlen($brandId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $brandId when calling Createmessagebrands., must be smaller than or equal to 45.');
        }
    ...
    public function setEin($ein)
    {
        ...
        if ((mb_strlen($ein) > 20)) {
            throw new \InvalidArgumentException('invalid length for $ein when calling Createmessagebrands., must be smaller than or equal to 20.');
        }
    ...
    public function setBrandRelationship($brandRelationship)
    {
        ...
        if ((mb_strlen($brandRelationship) > 45)) {
            throw new \InvalidArgumentException('invalid length for $brandRelationship when calling Createmessagebrands., must be smaller than or equal to 45.');
        }
    ...
    public function setVertical($vertical)
    {
        ...
        if ((mb_strlen($vertical) > 45)) {
            throw new \InvalidArgumentException('invalid length for $vertical when calling Createmessagebrands., must be smaller than or equal to 45.');
        }
    ...
    public function setEntityType($entityType)
    {
        ...
        if ((mb_strlen($entityType) > 45)) {
            throw new \InvalidArgumentException('invalid length for $entityType when calling Createmessagebrands., must be smaller than or equal to 45.');
        }
    ...
    public function setCspId($cspId)
    {
        ...
        if ((mb_strlen($cspId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $cspId when calling Createmessagebrands., must be smaller than or equal to 45.');
        }
    ...
    public function setEinIssuingCountry($einIssuingCountry)
    {
        ...
        if ((mb_strlen($einIssuingCountry) > 2)) {
            throw new \InvalidArgumentException('invalid length for $einIssuingCountry when calling Createmessagebrands., must be smaller than or equal to 2.');
        }
    ...
    public function setUniversalEin($universalEin)
    {
        ...
        if ((mb_strlen($universalEin) > 45)) {
            throw new \InvalidArgumentException('invalid length for $universalEin when calling Createmessagebrands., must be smaller than or equal to 45.');
        }
    ...
    public function setReferenceId($referenceId)
    {
        ...
        if ((mb_strlen($referenceId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $referenceId when calling Createmessagebrands., must be smaller than or equal to 45.');
        }
