<?php
/**
 * DeveloperappsubscriptionsNotRequired
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * DeveloperappsubscriptionsNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeveloperappsubscriptionsNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'developerappsubscriptionsNotRequired';
    ...
    */
    ...
    public function setRef($ref)
    {
        ...
        if (!is_null($ref) && (mb_strlen($ref) > 45)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling DeveloperappsubscriptionsNotRequired., must be smaller than or equal to 45.');
        }
