...
/**
 * Createnumberports Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Createnumberports implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createnumberports';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Createnumberports., must be smaller than or equal to 45.');
        }
    ...
    public function setAuthorizedPerson($authorizedPerson)
    {
        ...
        if ((mb_strlen($authorizedPerson) > 45)) {
            throw new \InvalidArgumentException('invalid length for $authorizedPerson when calling Createnumberports., must be smaller than or equal to 45.');
        }
    ...
    public function setAccountNumber($accountNumber)
    {
        ...
        if ((mb_strlen($accountNumber) > 45)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling Createnumberports., must be smaller than or equal to 45.');
        }
    ...
    public function setAccountPhoneNumber($accountPhoneNumber)
    {
        ...
        if ((mb_strlen($accountPhoneNumber) > 20)) {
            throw new \InvalidArgumentException('invalid length for $accountPhoneNumber when calling Createnumberports., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($accountPhoneNumber) < 10)) {
            throw new \InvalidArgumentException('invalid length for $accountPhoneNumber when calling Createnumberports., must be bigger than or equal to 10.');
        }
    ...
    public function setRef($ref)
    {
        ...
        if ((mb_strlen($ref) > 100)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling Createnumberports., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($ref) < 5)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling Createnumberports., must be bigger than or equal to 5.');
        }
    ...
    public function setCallForwardingDestination($callForwardingDestination)
    {
        ...
        if ((mb_strlen($callForwardingDestination) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callForwardingDestination when calling Createnumberports., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($callForwardingDestination) < 10)) {
            throw new \InvalidArgumentException('invalid length for $callForwardingDestination when calling Createnumberports., must be bigger than or equal to 10.');
        }
