...
/**
 * ConferenceroomsNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConferenceroomsNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'conferenceroomsNotRequired';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ConferenceroomsNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setPasscode($passcode)
    {
        ...
        if (!is_null($passcode) && (mb_strlen($passcode) > 20)) {
            throw new \InvalidArgumentException('invalid length for $passcode when calling ConferenceroomsNotRequired., must be smaller than or equal to 20.');
        }
        if (!is_null($passcode) && (mb_strlen($passcode) < 6)) {
            throw new \InvalidArgumentException('invalid length for $passcode when calling ConferenceroomsNotRequired., must be bigger than or equal to 6.');
        }
