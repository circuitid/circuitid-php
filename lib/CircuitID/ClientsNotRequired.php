...
/**
 * ClientsNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ClientsNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'clientsNotRequired';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ClientsNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setMac($mac)
    {
        ...
        if (!is_null($mac) && (mb_strlen($mac) > 45)) {
            throw new \InvalidArgumentException('invalid length for $mac when calling ClientsNotRequired., must be smaller than or equal to 45.');
        }
        if (!is_null($mac) && (mb_strlen($mac) < 5)) {
            throw new \InvalidArgumentException('invalid length for $mac when calling ClientsNotRequired., must be bigger than or equal to 5.');
        }
    ...
    public function setHttpUserAgent($httpUserAgent)
    {
        ...
        if (!is_null($httpUserAgent) && (mb_strlen($httpUserAgent) > 45)) {
            throw new \InvalidArgumentException('invalid length for $httpUserAgent when calling ClientsNotRequired., must be smaller than or equal to 45.');
        }
        if (!is_null($httpUserAgent) && (mb_strlen($httpUserAgent) < 1)) {
            throw new \InvalidArgumentException('invalid length for $httpUserAgent when calling ClientsNotRequired., must be bigger than or equal to 1.');
        }
    ...
    public function setManufacture($manufacture)
    {
        ...
        if (!is_null($manufacture) && (mb_strlen($manufacture) > 20)) {
            throw new \InvalidArgumentException('invalid length for $manufacture when calling ClientsNotRequired., must be smaller than or equal to 20.');
        }
        if (!is_null($manufacture) && (mb_strlen($manufacture) < 4)) {
            throw new \InvalidArgumentException('invalid length for $manufacture when calling ClientsNotRequired., must be bigger than or equal to 4.');
        }
