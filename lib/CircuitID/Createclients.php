...
/**
 * Createclients Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Createclients implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createclients';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Createclients., must be smaller than or equal to 45.');
        }
    ...
    public function setMac($mac)
    {
        ...
        if ((mb_strlen($mac) > 45)) {
            throw new \InvalidArgumentException('invalid length for $mac when calling Createclients., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($mac) < 5)) {
            throw new \InvalidArgumentException('invalid length for $mac when calling Createclients., must be bigger than or equal to 5.');
        }
    ...
    public function setHttpUserAgent($httpUserAgent)
    {
        ...
        if ((mb_strlen($httpUserAgent) > 45)) {
            throw new \InvalidArgumentException('invalid length for $httpUserAgent when calling Createclients., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($httpUserAgent) < 1)) {
            throw new \InvalidArgumentException('invalid length for $httpUserAgent when calling Createclients., must be bigger than or equal to 1.');
        }
    ...
    public function setManufacture($manufacture)
    {
        ...
        if ((mb_strlen($manufacture) > 20)) {
            throw new \InvalidArgumentException('invalid length for $manufacture when calling Createclients., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($manufacture) < 4)) {
            throw new \InvalidArgumentException('invalid length for $manufacture when calling Createclients., must be bigger than or equal to 4.');
        }
