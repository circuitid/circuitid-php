...
/**
 * GetPhoneOutboundRule200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetPhoneOutboundRule200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getPhoneOutbound_Rule_200_response';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GetPhoneOutboundRule200Response., must be smaller than or equal to 45.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling GetPhoneOutboundRule200Response., must be smaller than or equal to 255.');
        }
    ...
    public function setOutboundCallerId($outboundCallerId)
    {
        ...
        if ((mb_strlen($outboundCallerId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $outboundCallerId when calling GetPhoneOutboundRule200Response., must be smaller than or equal to 45.');
        }
