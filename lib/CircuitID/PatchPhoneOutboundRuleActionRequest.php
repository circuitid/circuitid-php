...
/**
 * PatchPhoneOutboundRuleActionRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchPhoneOutboundRuleActionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchPhoneOutbound_Rule_Action_request';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchPhoneOutboundRuleActionRequest., must be smaller than or equal to 45.');
        }
     ...
     *
     * @param mixed|null $phoneoutboundrule ObjectId (unique 12 bytes ID)
     *
     * @return self
     */
    ...
    public function setStartingChars($startingChars)
    {
        ...
        if (!is_null($startingChars) && (mb_strlen($startingChars) > 20)) {
            throw new \InvalidArgumentException('invalid length for $startingChars when calling PatchPhoneOutboundRuleActionRequest., must be smaller than or equal to 20.');
        }
    ...
    public function setContains($contains)
    {
        ...
        if (!is_null($contains) && (mb_strlen($contains) > 20)) {
            throw new \InvalidArgumentException('invalid length for $contains when calling PatchPhoneOutboundRuleActionRequest., must be smaller than or equal to 20.');
        }
    ...
    public function setAppendChars($appendChars)
    {
        ...
        if (!is_null($appendChars) && (mb_strlen($appendChars) > 20)) {
            throw new \InvalidArgumentException('invalid length for $appendChars when calling PatchPhoneOutboundRuleActionRequest., must be smaller than or equal to 20.');
        }
    ...
    public function setPrependChars($prependChars)
    {
        ...
        if (!is_null($prependChars) && (mb_strlen($prependChars) > 20)) {
            throw new \InvalidArgumentException('invalid length for $prependChars when calling PatchPhoneOutboundRuleActionRequest., must be smaller than or equal to 20.');
        }
