...
/**
 * GetTimeSchedule200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetTimeSchedule200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTimeSchedule_200_response';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'timezone' => 'string',
        'sunday' => '\OpenAPI\Client\CircuitID\TimeschedulesSunday',
        'monday' => '\OpenAPI\Client\CircuitID\TimeschedulesSunday',
        'tuesday' => '\OpenAPI\Client\CircuitID\TimeschedulesSunday',
        'wednesday' => '\OpenAPI\Client\CircuitID\TimeschedulesSunday',
        'thursday' => '\OpenAPI\Client\CircuitID\TimeschedulesSunday',
        'friday' => '\OpenAPI\Client\CircuitID\TimeschedulesSunday',
        'saturday' => '\OpenAPI\Client\CircuitID\TimeschedulesSunday',
        'id' => 'string',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GetTimeSchedule200Response., must be smaller than or equal to 45.');
        }
    ...
    public function setTimezone($timezone)
    {
        ...
        if ((mb_strlen($timezone) > 45)) {
            throw new \InvalidArgumentException('invalid length for $timezone when calling GetTimeSchedule200Response., must be smaller than or equal to 45.');
        }
     ...
     * Gets sunday
     *
     * @return \OpenAPI\Client\CircuitID\TimeschedulesSunday
     */
     ...
     * Sets sunday
     *
     * @param \OpenAPI\Client\CircuitID\TimeschedulesSunday $sunday sunday
     *
     * @return self
     */
     ...
     * Sets monday
     *
     * @param \OpenAPI\Client\CircuitID\TimeschedulesSunday $monday monday
     *
     * @return self
     */
     ...
     * Sets tuesday
     *
     * @param \OpenAPI\Client\CircuitID\TimeschedulesSunday $tuesday tuesday
     *
     * @return self
     */
     ...
     * Sets wednesday
     *
     * @param \OpenAPI\Client\CircuitID\TimeschedulesSunday $wednesday wednesday
     *
     * @return self
     */
     ...
     * Sets thursday
     *
     * @param \OpenAPI\Client\CircuitID\TimeschedulesSunday $thursday thursday
     *
     * @return self
     */
     ...
     * Sets friday
     *
     * @param \OpenAPI\Client\CircuitID\TimeschedulesSunday $friday friday
     *
     * @return self
     */
     ...
     * Sets saturday
     *
     * @param \OpenAPI\Client\CircuitID\TimeschedulesSunday $saturday saturday
     *
     * @return self
     */
