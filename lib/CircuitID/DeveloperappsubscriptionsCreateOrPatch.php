...
/**
 * DeveloperappsubscriptionsCreateOrPatch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeveloperappsubscriptionsCreateOrPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'developerappsubscriptionsCreateOrPatch';
    ...
    */
    ...
    public function setRef($ref)
    {
        ...
        if ((mb_strlen($ref) > 45)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling DeveloperappsubscriptionsCreateOrPatch., must be smaller than or equal to 45.');
        }
