...
/**
 * PatchDeveloperAppRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchDeveloperAppRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchDeveloperApp_request';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchDeveloperAppRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchDeveloperAppRequest., must be smaller than or equal to 4096.');
        }
    ...
    public function setFeeDescription($feeDescription)
    {
        ...
        if (!is_null($feeDescription) && (mb_strlen($feeDescription) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $feeDescription when calling PatchDeveloperAppRequest., must be smaller than or equal to 4096.');
        }
    ...
    public function setWebhookUrl($webhookUrl)
    {
        ...
        if (!is_null($webhookUrl) && (mb_strlen($webhookUrl) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $webhookUrl when calling PatchDeveloperAppRequest., must be smaller than or equal to 1024.');
        }
    ...
    public function setTermsOfServiceUrl($termsOfServiceUrl)
    {
        ...
        if (!is_null($termsOfServiceUrl) && (mb_strlen($termsOfServiceUrl) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $termsOfServiceUrl when calling PatchDeveloperAppRequest., must be smaller than or equal to 1024.');
        }
    ...
    public function setPrivacyPolicyUrl($privacyPolicyUrl)
    {
        ...
        if (!is_null($privacyPolicyUrl) && (mb_strlen($privacyPolicyUrl) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $privacyPolicyUrl when calling PatchDeveloperAppRequest., must be smaller than or equal to 1024.');
        }
    ...
    public function setWebhookUsername($webhookUsername)
    {
        ...
        if (!is_null($webhookUsername) && (mb_strlen($webhookUsername) > 255)) {
            throw new \InvalidArgumentException('invalid length for $webhookUsername when calling PatchDeveloperAppRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setWebhookPassword($webhookPassword)
    {
        ...
        if (!is_null($webhookPassword) && (mb_strlen($webhookPassword) > 255)) {
            throw new \InvalidArgumentException('invalid length for $webhookPassword when calling PatchDeveloperAppRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setWebhookTokenName($webhookTokenName)
    {
        ...
        if (!is_null($webhookTokenName) && (mb_strlen($webhookTokenName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $webhookTokenName when calling PatchDeveloperAppRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setWebhookToken($webhookToken)
    {
        ...
        if (!is_null($webhookToken) && (mb_strlen($webhookToken) > 255)) {
            throw new \InvalidArgumentException('invalid length for $webhookToken when calling PatchDeveloperAppRequest., must be smaller than or equal to 255.');
        }
