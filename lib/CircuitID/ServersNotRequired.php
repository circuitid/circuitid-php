...
/**
 * ServersNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServersNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'serversNotRequired';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ServersNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setHost($host)
    {
        ...
        if (!is_null($host) && (mb_strlen($host) > 45)) {
            throw new \InvalidArgumentException('invalid length for $host when calling ServersNotRequired., must be smaller than or equal to 45.');
        }
        if (!is_null($host) && (mb_strlen($host) < 5)) {
            throw new \InvalidArgumentException('invalid length for $host when calling ServersNotRequired., must be bigger than or equal to 5.');
        }
    ...
    public function setCallerId($callerId)
    {
        ...
        if (!is_null($callerId) && (mb_strlen($callerId) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callerId when calling ServersNotRequired., must be smaller than or equal to 45.');
        }
