...
/**
 * NumberportsCreateOrPatch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NumberportsCreateOrPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'numberportsCreateOrPatch';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NumberportsCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setAuthorizedPerson($authorizedPerson)
    {
        ...
        if ((mb_strlen($authorizedPerson) > 45)) {
            throw new \InvalidArgumentException('invalid length for $authorizedPerson when calling NumberportsCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setAccountNumber($accountNumber)
    {
        ...
        if ((mb_strlen($accountNumber) > 45)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling NumberportsCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setAccountPhoneNumber($accountPhoneNumber)
    {
        ...
        if ((mb_strlen($accountPhoneNumber) > 20)) {
            throw new \InvalidArgumentException('invalid length for $accountPhoneNumber when calling NumberportsCreateOrPatch., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($accountPhoneNumber) < 10)) {
            throw new \InvalidArgumentException('invalid length for $accountPhoneNumber when calling NumberportsCreateOrPatch., must be bigger than or equal to 10.');
        }
    ...
    public function setCallForwardingDestination($callForwardingDestination)
    {
        ...
        if ((mb_strlen($callForwardingDestination) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callForwardingDestination when calling NumberportsCreateOrPatch., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($callForwardingDestination) < 10)) {
            throw new \InvalidArgumentException('invalid length for $callForwardingDestination when calling NumberportsCreateOrPatch., must be bigger than or equal to 10.');
        }
