...
/**
 * PatchCallQueueRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchCallQueueRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchCallQueue_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['moh']) && (mb_strlen($this->container['moh']) > 255)) {
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchCallQueueRequest., must be smaller than or equal to 45.');
        }
     ...
     * Sets strategy
     *
     * @param mixed|null $strategy strategy
     *
     * @return self
     */
    ...
    public function setMoh($moh)
    {
        ...
        if (!is_null($moh) && (mb_strlen($moh) > 255)) {
            throw new \InvalidArgumentException('invalid length for $moh when calling PatchCallQueueRequest., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param mixed|null $callerResumeTimeout callerResumeTimeout
     *
     * @return self
     */
     ...
     * Sets maxWaitTime
     *
     * @param mixed|null $maxWaitTime maxWaitTime
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $maxWaitTimeNoAgent maxWaitTimeNoAgent
     *
     * @return self
     */
     ...
     * Sets maxNoAnswer
     *
     * @param mixed|null $maxNoAnswer maxNoAnswer
     *
     * @return self
     */
     ...
     * Sets timeBasedScore
     *
     * @param mixed|null $timeBasedScore timeBasedScore
     *
     * @return self
     */
     ...
     * Sets tierRulesApply
     *
     * @param mixed|null $tierRulesApply tierRulesApply
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $tierRuleNoAgentNoWait tierRuleNoAgentNoWait
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $tierRuleWaitMultiplyLevel tierRuleWaitMultiplyLevel
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $abandonedResumeAllowed abandonedResumeAllowed
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $maxWaitTimeNoAgentTimeReached maxWaitTimeNoAgentTimeReached
     *
     * @return self
     */
