    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Createcustomers., must be smaller than or equal to 45.');
        }
    ...
    public function setWebsiteUrl($websiteUrl)
    {
        ...
        if ((mb_strlen($websiteUrl) > 255)) {
            throw new \InvalidArgumentException('invalid length for $websiteUrl when calling Createcustomers., must be smaller than or equal to 255.');
        }
    ...
    public function setLogo($logo)
    {
        ...
        if ((mb_strlen($logo) > 255)) {
            throw new \InvalidArgumentException('invalid length for $logo when calling Createcustomers., must be smaller than or equal to 255.');
        }
    ...
    public function setCreatedByIP($createdByIP)
    {
        ...
        if ((mb_strlen($createdByIP) > 45)) {
            throw new \InvalidArgumentException('invalid length for $createdByIP when calling Createcustomers., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($createdByIP) < 8)) {
            throw new \InvalidArgumentException('invalid length for $createdByIP when calling Createcustomers., must be bigger than or equal to 8.');
        }
