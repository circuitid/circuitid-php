...
/**
 * PhoneoutboundruleactionsCreateOrPatch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PhoneoutboundruleactionsCreateOrPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'phoneoutboundruleactionsCreateOrPatch';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PhoneoutboundruleactionsCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setStartingChars($startingChars)
    {
        ...
        if ((mb_strlen($startingChars) > 20)) {
            throw new \InvalidArgumentException('invalid length for $startingChars when calling PhoneoutboundruleactionsCreateOrPatch., must be smaller than or equal to 20.');
        }
    ...
    public function setContains($contains)
    {
        ...
        if ((mb_strlen($contains) > 20)) {
            throw new \InvalidArgumentException('invalid length for $contains when calling PhoneoutboundruleactionsCreateOrPatch., must be smaller than or equal to 20.');
        }
    ...
    public function setAppendChars($appendChars)
    {
        ...
        if ((mb_strlen($appendChars) > 20)) {
            throw new \InvalidArgumentException('invalid length for $appendChars when calling PhoneoutboundruleactionsCreateOrPatch., must be smaller than or equal to 20.');
        }
    ...
    public function setPrependChars($prependChars)
    {
        ...
        if ((mb_strlen($prependChars) > 20)) {
            throw new \InvalidArgumentException('invalid length for $prependChars when calling PhoneoutboundruleactionsCreateOrPatch., must be smaller than or equal to 20.');
        }
