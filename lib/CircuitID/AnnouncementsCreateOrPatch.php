...
/**
 * AnnouncementsCreateOrPatch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AnnouncementsCreateOrPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'announcementsCreateOrPatch';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AnnouncementsCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 255)) {
            throw new \InvalidArgumentException('invalid length for $text when calling AnnouncementsCreateOrPatch., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($text) < 2)) {
            throw new \InvalidArgumentException('invalid length for $text when calling AnnouncementsCreateOrPatch., must be bigger than or equal to 2.');
        }
