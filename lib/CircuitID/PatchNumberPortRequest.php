...
/**
 * PatchNumberPortRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchNumberPortRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchNumberPort_request';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchNumberPortRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setAuthorizedPerson($authorizedPerson)
    {
        ...
        if (!is_null($authorizedPerson) && (mb_strlen($authorizedPerson) > 45)) {
            throw new \InvalidArgumentException('invalid length for $authorizedPerson when calling PatchNumberPortRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setAccountNumber($accountNumber)
    {
        ...
        if (!is_null($accountNumber) && (mb_strlen($accountNumber) > 45)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling PatchNumberPortRequest., must be smaller than or equal to 45.');
        }
    ...
    public function setAccountPhoneNumber($accountPhoneNumber)
    {
        ...
        if (!is_null($accountPhoneNumber) && (mb_strlen($accountPhoneNumber) > 20)) {
            throw new \InvalidArgumentException('invalid length for $accountPhoneNumber when calling PatchNumberPortRequest., must be smaller than or equal to 20.');
        }
        if (!is_null($accountPhoneNumber) && (mb_strlen($accountPhoneNumber) < 10)) {
            throw new \InvalidArgumentException('invalid length for $accountPhoneNumber when calling PatchNumberPortRequest., must be bigger than or equal to 10.');
        }
    ...
    public function setRef($ref)
    {
        ...
        if (!is_null($ref) && (mb_strlen($ref) > 100)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling PatchNumberPortRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($ref) && (mb_strlen($ref) < 5)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling PatchNumberPortRequest., must be bigger than or equal to 5.');
        }
    ...
    public function setCallForwardingDestination($callForwardingDestination)
    {
        ...
        if (!is_null($callForwardingDestination) && (mb_strlen($callForwardingDestination) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callForwardingDestination when calling PatchNumberPortRequest., must be smaller than or equal to 45.');
        }
        if (!is_null($callForwardingDestination) && (mb_strlen($callForwardingDestination) < 10)) {
            throw new \InvalidArgumentException('invalid length for $callForwardingDestination when calling PatchNumberPortRequest., must be bigger than or equal to 10.');
        }
