...
/**
 * Developerapps Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Developerapps implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'developerapps';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Developerapps., must be smaller than or equal to 45.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Developerapps., must be smaller than or equal to 4096.');
        }
    ...
    public function setFeeDescription($feeDescription)
    {
        ...
        if ((mb_strlen($feeDescription) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $feeDescription when calling Developerapps., must be smaller than or equal to 4096.');
        }
    ...
    public function setWebhookUrl($webhookUrl)
    {
        ...
        if ((mb_strlen($webhookUrl) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $webhookUrl when calling Developerapps., must be smaller than or equal to 1024.');
        }
    ...
    public function setTermsOfServiceUrl($termsOfServiceUrl)
    {
        ...
        if ((mb_strlen($termsOfServiceUrl) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $termsOfServiceUrl when calling Developerapps., must be smaller than or equal to 1024.');
        }
    ...
    public function setPrivacyPolicyUrl($privacyPolicyUrl)
    {
        ...
        if ((mb_strlen($privacyPolicyUrl) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $privacyPolicyUrl when calling Developerapps., must be smaller than or equal to 1024.');
        }
    ...
    public function setWebhookUsername($webhookUsername)
    {
        ...
        if ((mb_strlen($webhookUsername) > 255)) {
            throw new \InvalidArgumentException('invalid length for $webhookUsername when calling Developerapps., must be smaller than or equal to 255.');
        }
    ...
    public function setWebhookPassword($webhookPassword)
    {
        ...
        if ((mb_strlen($webhookPassword) > 255)) {
            throw new \InvalidArgumentException('invalid length for $webhookPassword when calling Developerapps., must be smaller than or equal to 255.');
        }
    ...
    public function setWebhookTokenName($webhookTokenName)
    {
        ...
        if ((mb_strlen($webhookTokenName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $webhookTokenName when calling Developerapps., must be smaller than or equal to 255.');
        }
    ...
    public function setWebhookToken($webhookToken)
    {
        ...
        if ((mb_strlen($webhookToken) > 255)) {
            throw new \InvalidArgumentException('invalid length for $webhookToken when calling Developerapps., must be smaller than or equal to 255.');
        }
