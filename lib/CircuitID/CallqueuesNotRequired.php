...
/**
 * CallqueuesNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CallqueuesNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'callqueuesNotRequired';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CallqueuesNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setMoh($moh)
    {
        ...
        if (!is_null($moh) && (mb_strlen($moh) > 255)) {
            throw new \InvalidArgumentException('invalid length for $moh when calling CallqueuesNotRequired., must be smaller than or equal to 255.');
        }
