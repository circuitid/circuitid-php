...
/**
 * GetDeveloperAppSubscription200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetDeveloperAppSubscription200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getDeveloperApp_Subscription_200_response';
    ...
    */
    ...
    public function setRef($ref)
    {
        ...
        if ((mb_strlen($ref) > 45)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling GetDeveloperAppSubscription200Response., must be smaller than or equal to 45.');
        }
