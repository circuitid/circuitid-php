...
/**
 * LicensesNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LicensesNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'licensesNotRequired';
    ...
    */
    ...
    public function setRef($ref)
    {
        ...
        if (!is_null($ref) && (mb_strlen($ref) > 45)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling LicensesNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setField($field)
    {
        ...
        if (!is_null($field) && (mb_strlen($field) > 45)) {
            throw new \InvalidArgumentException('invalid length for $field when calling LicensesNotRequired., must be smaller than or equal to 45.');
        }
