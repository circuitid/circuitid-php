...
/**
 * CallqueuesCreateOrPatch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CallqueuesCreateOrPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'callqueuesCreateOrPatch';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CallqueuesCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setMoh($moh)
    {
        ...
        if ((mb_strlen($moh) > 255)) {
            throw new \InvalidArgumentException('invalid length for $moh when calling CallqueuesCreateOrPatch., must be smaller than or equal to 255.');
        }
