...
/**
 * GetFax200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetFax200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getFax_200_response';
    ...
    */
    ...
    public function setCallerIdNumber($callerIdNumber)
    {
        ...
        if ((mb_strlen($callerIdNumber) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callerIdNumber when calling GetFax200Response., must be smaller than or equal to 45.');
        }
    ...
    public function setCallerDestination($callerDestination)
    {
        ...
        if ((mb_strlen($callerDestination) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callerDestination when calling GetFax200Response., must be smaller than or equal to 45.');
        }
    ...
    public function setError($error)
    {
        ...
        if ((mb_strlen($error) > 255)) {
            throw new \InvalidArgumentException('invalid length for $error when calling GetFax200Response., must be smaller than or equal to 255.');
        }
    ...
    public function setSenderEmail($senderEmail)
    {
        ...
        if ((mb_strlen($senderEmail) > 45)) {
            throw new \InvalidArgumentException('invalid length for $senderEmail when calling GetFax200Response., must be smaller than or equal to 45.');
        }
    ...
    public function setSenderName($senderName)
    {
        ...
        if ((mb_strlen($senderName) > 45)) {
            throw new \InvalidArgumentException('invalid length for $senderName when calling GetFax200Response., must be smaller than or equal to 45.');
        }
