...
/**
 * RatecentersNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RatecentersNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ratecentersNotRequired';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['npa']) && (mb_strlen($this->container['npa']) > 3)) {
        ...
        if (!is_null($this->container['nxx']) && (mb_strlen($this->container['nxx']) > 3)) {
        ...
        if (!is_null($this->container['lata']) && (mb_strlen($this->container['lata']) > 3)) {
        ...
        if (!is_null($this->container['locState']) && (mb_strlen($this->container['locState']) > 2)) {
        ...
        if (!is_null($this->container['rcAbbre']) && (mb_strlen($this->container['rcAbbre']) > 45)) {
    ...
    public function setNpa($npa)
    {
        ...
        if (!is_null($npa) && (mb_strlen($npa) > 3)) {
            throw new \InvalidArgumentException('invalid length for $npa when calling RatecentersNotRequired., must be smaller than or equal to 3.');
        }
        if (!is_null($npa) && (mb_strlen($npa) < 3)) {
            throw new \InvalidArgumentException('invalid length for $npa when calling RatecentersNotRequired., must be bigger than or equal to 3.');
        }
    ...
    public function setNxx($nxx)
    {
        ...
        if (!is_null($nxx) && (mb_strlen($nxx) > 3)) {
            throw new \InvalidArgumentException('invalid length for $nxx when calling RatecentersNotRequired., must be smaller than or equal to 3.');
        }
        if (!is_null($nxx) && (mb_strlen($nxx) < 3)) {
            throw new \InvalidArgumentException('invalid length for $nxx when calling RatecentersNotRequired., must be bigger than or equal to 3.');
        }
    ...
    public function setLata($lata)
    {
        ...
        if (!is_null($lata) && (mb_strlen($lata) > 3)) {
            throw new \InvalidArgumentException('invalid length for $lata when calling RatecentersNotRequired., must be smaller than or equal to 3.');
        }
        if (!is_null($lata) && (mb_strlen($lata) < 3)) {
            throw new \InvalidArgumentException('invalid length for $lata when calling RatecentersNotRequired., must be bigger than or equal to 3.');
        }
     ...
     * Sets locState
     *
     * @param mixed|null $locState locState
     *
     * @return self
     */
    public function setLocState($locState)
    {
        ...
        if (!is_null($locState) && (mb_strlen($locState) > 2)) {
            throw new \InvalidArgumentException('invalid length for $locState when calling RatecentersNotRequired., must be smaller than or equal to 2.');
        }
        if (!is_null($locState) && (mb_strlen($locState) < 2)) {
            throw new \InvalidArgumentException('invalid length for $locState when calling RatecentersNotRequired., must be bigger than or equal to 2.');
        }
     ...
     * Sets rcAbbre
     *
     * @param mixed|null $rcAbbre rcAbbre
     *
     * @return self
     */
    public function setRcAbbre($rcAbbre)
    {
        ...
        if (!is_null($rcAbbre) && (mb_strlen($rcAbbre) > 45)) {
            throw new \InvalidArgumentException('invalid length for $rcAbbre when calling RatecentersNotRequired., must be smaller than or equal to 45.');
        }
