...
/**
 * OfficesNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OfficesNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'officesNotRequired';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling OfficesNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setStreetNumber($streetNumber)
    {
        ...
        if (!is_null($streetNumber) && (mb_strlen($streetNumber) > 45)) {
            throw new \InvalidArgumentException('invalid length for $streetNumber when calling OfficesNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setStreetName($streetName)
    {
        ...
        if (!is_null($streetName) && (mb_strlen($streetName) > 20)) {
            throw new \InvalidArgumentException('invalid length for $streetName when calling OfficesNotRequired., must be smaller than or equal to 20.');
        }
    ...
    public function setPreDirection($preDirection)
    {
        ...
        if (!is_null($preDirection) && (mb_strlen($preDirection) > 2)) {
            throw new \InvalidArgumentException('invalid length for $preDirection when calling OfficesNotRequired., must be smaller than or equal to 2.');
        }
    ...
    public function setStreetSuffix($streetSuffix)
    {
        ...
        if (!is_null($streetSuffix) && (mb_strlen($streetSuffix) > 4)) {
            throw new \InvalidArgumentException('invalid length for $streetSuffix when calling OfficesNotRequired., must be smaller than or equal to 4.');
        }
        if (!is_null($streetSuffix) && (mb_strlen($streetSuffix) < 2)) {
            throw new \InvalidArgumentException('invalid length for $streetSuffix when calling OfficesNotRequired., must be bigger than or equal to 2.');
        }
    ...
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (mb_strlen($city) > 45)) {
            throw new \InvalidArgumentException('invalid length for $city when calling OfficesNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setState($state)
    {
        ...
        if (!is_null($state) && (mb_strlen($state) > 45)) {
            throw new \InvalidArgumentException('invalid length for $state when calling OfficesNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setZipCode($zipCode)
    {
        ...
        if (!is_null($zipCode) && (mb_strlen($zipCode) > 45)) {
            throw new \InvalidArgumentException('invalid length for $zipCode when calling OfficesNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setAddress2($address2)
    {
        ...
        if (!is_null($address2) && (mb_strlen($address2) > 45)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling OfficesNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling OfficesNotRequired., must be smaller than or equal to 2.');
        }
        if (!is_null($country) && (mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling OfficesNotRequired., must be bigger than or equal to 2.');
        }
