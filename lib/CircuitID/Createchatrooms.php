...
/**
 * Createchatrooms Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Createchatrooms implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createchatrooms';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Createchatrooms., must be smaller than or equal to 255.');
        }
    ...
    public function setAvatar($avatar)
    {
        ...
        if ((mb_strlen($avatar) > 512)) {
            throw new \InvalidArgumentException('invalid length for $avatar when calling Createchatrooms., must be smaller than or equal to 512.');
        }
