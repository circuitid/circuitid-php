...
/**
 * TimeschedulesNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TimeschedulesNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'timeschedulesNotRequired';
    ...
    public const TIMEZONE_ETC_GMT0 = 'Etc/GMT0';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['timezone']) && (mb_strlen($this->container['timezone']) > 45)) {
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TimeschedulesNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setTimezone($timezone)
    {
        ...
        if (!is_null($timezone) && (mb_strlen($timezone) > 45)) {
            throw new \InvalidArgumentException('invalid length for $timezone when calling TimeschedulesNotRequired., must be smaller than or equal to 45.');
        }
     ...
     * Sets sunday
     *
     * @param mixed|null $sunday sunday
     *
     * @return self
     */
     ...
     * Sets monday
     *
     * @param mixed|null $monday monday
     *
     * @return self
     */
     ...
     * Sets tuesday
     *
     * @param mixed|null $tuesday tuesday
     *
     * @return self
     */
     ...
     * Sets wednesday
     *
     * @param mixed|null $wednesday wednesday
     *
     * @return self
     */
     ...
     * Sets thursday
     *
     * @param mixed|null $thursday thursday
     *
     * @return self
     */
     ...
     * Sets friday
     *
     * @param mixed|null $friday friday
     *
     * @return self
     */
     ...
     * Sets saturday
     *
     * @param mixed|null $saturday saturday
     *
     * @return self
     */
