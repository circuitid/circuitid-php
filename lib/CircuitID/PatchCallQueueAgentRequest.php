...
/**
 * PatchCallQueueAgentRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchCallQueueAgentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchCallQueue_Agent_request';
    ...
    */
     ...
     * Sets callqueue
     *
     * @param mixed|null $callqueue ObjectId (unique 12 bytes ID)
     *
     * @return self
     */
