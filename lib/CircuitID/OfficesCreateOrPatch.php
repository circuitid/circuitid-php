...
/**
 * OfficesCreateOrPatch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OfficesCreateOrPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'officesCreateOrPatch';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling OfficesCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setStreetNumber($streetNumber)
    {
        ...
        if ((mb_strlen($streetNumber) > 45)) {
            throw new \InvalidArgumentException('invalid length for $streetNumber when calling OfficesCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setStreetName($streetName)
    {
        ...
        if ((mb_strlen($streetName) > 20)) {
            throw new \InvalidArgumentException('invalid length for $streetName when calling OfficesCreateOrPatch., must be smaller than or equal to 20.');
        }
    ...
    public function setPreDirection($preDirection)
    {
        ...
        if ((mb_strlen($preDirection) > 2)) {
            throw new \InvalidArgumentException('invalid length for $preDirection when calling OfficesCreateOrPatch., must be smaller than or equal to 2.');
        }
    ...
    public function setStreetSuffix($streetSuffix)
    {
        ...
        if ((mb_strlen($streetSuffix) > 4)) {
            throw new \InvalidArgumentException('invalid length for $streetSuffix when calling OfficesCreateOrPatch., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($streetSuffix) < 2)) {
            throw new \InvalidArgumentException('invalid length for $streetSuffix when calling OfficesCreateOrPatch., must be bigger than or equal to 2.');
        }
    ...
    public function setZipCode($zipCode)
    {
        ...
        if ((mb_strlen($zipCode) > 45)) {
            throw new \InvalidArgumentException('invalid length for $zipCode when calling OfficesCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setAddress2($address2)
    {
        ...
        if ((mb_strlen($address2) > 45)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling OfficesCreateOrPatch., must be smaller than or equal to 45.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling OfficesCreateOrPatch., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling OfficesCreateOrPatch., must be bigger than or equal to 2.');
        }
