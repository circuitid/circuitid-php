...
/**
 * PatchDeveloperAppSubscriptionRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchDeveloperAppSubscriptionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchDeveloperApp_Subscription_request';
    ...
    */
     ...
     * Sets developerApp
     *
     * @param mixed|null $developerApp ObjectId (unique 12 bytes ID)
     *
     * @return self
     */
    public function setDeveloperApp($developerApp)
    {
        if (is_null($developerApp)) {
            array_push($this->openAPINullablesSetToNull, 'developerApp');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('developerApp', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setRef($ref)
    {
        ...
        if (!is_null($ref) && (mb_strlen($ref) > 45)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling PatchDeveloperAppSubscriptionRequest., must be smaller than or equal to 45.');
        }
