...
class Timeschedules implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets wednesday
     *
     * @param mixed $wednesday wednesday
     *
     * @return self
     */
