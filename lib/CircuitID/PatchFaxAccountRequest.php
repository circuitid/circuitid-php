...
/**
 * PatchFaxAccountRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchFaxAccountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchFaxAccount_request';
    ...
    protected static $openAPITypes = [
        'name' => 'mixed',
        'order' => 'mixed',
        'inboundNotification' => 'mixed',
        'outboundNotification' => 'mixed',
        'number' => 'mixed'
    ];
    ...
    protected static array $openAPINullables = [
        'name' => true,
		'order' => true,
		'inboundNotification' => true,
		'outboundNotification' => true,
		'number' => true
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchFaxAccountRequest., must be smaller than or equal to 45.');
        }
     ...
     *
     * @param mixed|null $inboundNotification ObjectId (unique 12 bytes ID)
     *
     * @return self
     */
    public function setInboundNotification($inboundNotification)
    {
        if (is_null($inboundNotification)) {
            array_push($this->openAPINullablesSetToNull, 'inboundNotification');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('inboundNotification', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed|null $outboundNotification ObjectId (unique 12 bytes ID)
     *
     * @return self
     */
    public function setOutboundNotification($outboundNotification)
    {
        if (is_null($outboundNotification)) {
            array_push($this->openAPINullablesSetToNull, 'outboundNotification');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('outboundNotification', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
