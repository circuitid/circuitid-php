...
/**
 * MenuoptionsNotRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MenuoptionsNotRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'menuoptionsNotRequired';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling MenuoptionsNotRequired., must be smaller than or equal to 45.');
        }
    ...
    public function setRef($ref)
    {
        ...
        if (!is_null($ref) && (mb_strlen($ref) > 100)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling MenuoptionsNotRequired., must be smaller than or equal to 100.');
        }
        if (!is_null($ref) && (mb_strlen($ref) < 5)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling MenuoptionsNotRequired., must be bigger than or equal to 5.');
        }
    ...
    public function setCallForwardingDestination($callForwardingDestination)
    {
        ...
        if (!is_null($callForwardingDestination) && (mb_strlen($callForwardingDestination) > 45)) {
            throw new \InvalidArgumentException('invalid length for $callForwardingDestination when calling MenuoptionsNotRequired., must be smaller than or equal to 45.');
        }
        if (!is_null($callForwardingDestination) && (mb_strlen($callForwardingDestination) < 10)) {
            throw new \InvalidArgumentException('invalid length for $callForwardingDestination when calling MenuoptionsNotRequired., must be bigger than or equal to 10.');
        }
