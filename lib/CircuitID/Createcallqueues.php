...
/**
 * Createcallqueues Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Createcallqueues implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createcallqueues';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Createcallqueues., must be smaller than or equal to 45.');
        }
    ...
    public function setMoh($moh)
    {
        ...
        if ((mb_strlen($moh) > 255)) {
            throw new \InvalidArgumentException('invalid length for $moh when calling Createcallqueues., must be smaller than or equal to 255.');
        }
