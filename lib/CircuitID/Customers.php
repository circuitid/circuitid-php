    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Customers., must be smaller than or equal to 45.');
        }
    ...
    public function setWebsiteUrl($websiteUrl)
    {
        ...
        if (!is_null($websiteUrl) && (mb_strlen($websiteUrl) > 255)) {
            throw new \InvalidArgumentException('invalid length for $websiteUrl when calling Customers., must be smaller than or equal to 255.');
        }
    ...
    public function setLogo($logo)
    {
        ...
        if (!is_null($logo) && (mb_strlen($logo) > 255)) {
            throw new \InvalidArgumentException('invalid length for $logo when calling Customers., must be smaller than or equal to 255.');
        }
    ...
    public function setCreatedByIP($createdByIP)
    {
        ...
        if (!is_null($createdByIP) && (mb_strlen($createdByIP) > 45)) {
            throw new \InvalidArgumentException('invalid length for $createdByIP when calling Customers., must be smaller than or equal to 45.');
        }
        if (!is_null($createdByIP) && (mb_strlen($createdByIP) < 8)) {
            throw new \InvalidArgumentException('invalid length for $createdByIP when calling Customers., must be bigger than or equal to 8.');
        }
     ...
     *
     * @param mixed $defaultBillMethod defaultBillMethod
     *
     * @return self
     */
